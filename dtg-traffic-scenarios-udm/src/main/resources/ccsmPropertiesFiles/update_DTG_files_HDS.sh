...
#IPv4 HDS Example
TG_VM_NAME="seroius03059-udm.sero.gic.ericsson.se"
...
#Example for IPv4 HDS environment eccd-ibd-udm14544
NODE_NAME="seroph00072-vnf03"
...
then
  ...
  AUSF_TRAFFIC_FQDN=${NODE_NAME}"-ausfvip6.sero.gic.ericsson.se"
  UDM_TRAFFIC_FQDN=${NODE_NAME}"-udmvip6.sero.gic.ericsson.se"
  EIR_TRAFFIC_FQDN=${NODE_NAME}"-eirvip6.sero.gic.ericsson.se"
  UDR_TRAFFIC_FQDN=${NODE_NAME}"-udrvip6.sero.gic.ericsson.se"
  ...
  AUSF_TRAFFIC_FQDN=${NODE_NAME}"-ausfvip.sero.gic.ericsson.se"
  UDM_TRAFFIC_FQDN=${NODE_NAME}"-udmvip.sero.gic.ericsson.se"
  EIR_TRAFFIC_FQDN=${NODE_NAME}"-eirvip.sero.gic.ericsson.se"
  UDR_TRAFFIC_FQDN=${NODE_NAME}"-udrvip.sero.gic.ericsson.se"
