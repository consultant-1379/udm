Feature: AMF authentication Initiation Request with EAP-AKA (suci with protection schema 1)

Scenario: Authentication Initiation Request
  Given target type is AUSF_HTTP
  Given suci computed using Convert-IMSI-to-SUCI-Profile-1 algorithm
