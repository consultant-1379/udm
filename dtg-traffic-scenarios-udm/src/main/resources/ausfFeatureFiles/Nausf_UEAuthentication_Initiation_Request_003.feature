Feature: AMF authentication Initiation Request with EAP-AKA (suci)
...
#FT
#curl --http2-prior-knowledge -k -i -m 1 -X POST -H'content-type:application/json' -d'{"supiOrSuci":"suci-0-240-81-0000-0-0-0000000001","servingNetworkName":"5G:mnc222.mcc111.3gppnetwork.org"}' 'http://localhost:31384/nausf-auth/v1/ue-authentications'
