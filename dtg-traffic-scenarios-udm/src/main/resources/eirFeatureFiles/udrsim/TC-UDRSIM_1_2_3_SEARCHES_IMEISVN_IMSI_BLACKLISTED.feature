Feature:  EIR data population for IMEISVN + IMSI (1-3 Searches) Blacklisted
...
Scenario: Populate IMEISVN data
  ...
  [{
    ...
    "ldapAttributes": [
      ...
      {"name": "l1", "values": [{"ldapAttributeValueB":"AQ=="}]},
...
Scenario: Populate IMSI data
  ...
  [{
    ...
    "ldapAttributes": [
      ...
      {"name": "objectClass", "values": [{"ldapAttributeValueS":"top"}, {"ldapAttributeValueS":"EI8"}, {"ldapAttributeValueS":"CUDBExtensibleObject"}]},
...
Scenario: Populate MSISDN data
  ...
  [{
    ...
    "ldapAttributes": [
      {"name": "IMSI", "values": [{"ldapAttributeValueS":"<imsi>"}]},
      {"name": "objectClass", "values": [{"ldapAttributeValueS":"CUDBService"}, {"ldapAttributeValueS":"mscIdentities"}]},
