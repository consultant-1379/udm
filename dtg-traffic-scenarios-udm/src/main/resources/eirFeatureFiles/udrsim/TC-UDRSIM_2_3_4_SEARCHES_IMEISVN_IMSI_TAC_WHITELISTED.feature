Feature:  EIR data population for IMEISVN + IMSI + TAC (2-4 Searches) Whitelisted
# This covers following scenarios:
# - IMEI_CHECK_WHITELISTED_IMSI_TAC
# - IMEI_CHECK_WHITELISTED_IMEISVN_IMSI_TAC
...
Scenario: Populate IMEISVN data
  ...
  [{
    ...
    "ldapAttributes": [
      ...
      {"name": "l0", "values": [{"ldapAttributeValueB":"AQ=="}]},
