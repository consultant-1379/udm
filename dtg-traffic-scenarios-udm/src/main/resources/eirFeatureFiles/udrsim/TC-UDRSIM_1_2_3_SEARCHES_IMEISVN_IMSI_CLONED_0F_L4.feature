Feature:  EIR data population for IMEISVN + IMSI (cloned) (1-3 Searches) Whitelisted
# This covers following scenario:
# - IMEI_CHECK_WHITELISTED_CLONED_0F
  ...
  [{
    ...
    "ldapAttributes": [
      {"name": "IMSI", "values": [{"ldapAttributeValueS":"<imsi>"}]},
	    {"name": "clonedImeiSvn", "values": [{"ldapAttributeValueS":"<imei>0F"}, {"ldapAttributeValueS":"3520002100200055"}, {"ldapAttributeValueS":"3520003100200055"}]},
      {
        "name": "objectClass",
        "values": [
          {"ldapAttributeValueS": "top"},
