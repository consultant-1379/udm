...
#FT
#curl --http2-prior-knowledge -k -i -m 1 -X GET -H'content-type:application/json' 'http://localhost:32657/nudm-sdm/v2/imsi-240810000000000/sms-data'
...
Scenario: Send Get-SMS-Data
  ...
  Given path is /nudm-sdm/v2/imsi-<imsi>/sms-data
