Feature: AMF 3GPP Access Registration AMF1 Wrong dereg Callback
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d'{"amfInstanceId": "1ec823fe-4a62-4617-aabf-55d14627a3dd", "deregCallbackUri": "http://[2001:1b70:8209:4111::b]:8090/deregistration/imsi-240810000000100/","guami": {"plmnId": {"mcc": "111", "mnc": "222"}, "amfId": "A1B2C3"}, "ratType" : "NR"}' 'http://localhost:30096/nudm-uecm/v1/imsi-240810000000100/registrations/amf-3gpp-access'
...
Scenario: Send Register-Amf3GPPAccess-AMF1
  ...
  """
  {
    ...
    "deregCallbackUri" : "<AMF_SERVER_SCHEME>://<AMF_SERVER_ADDRESS>:9090/deregistration/imsi-<imsi>/",
