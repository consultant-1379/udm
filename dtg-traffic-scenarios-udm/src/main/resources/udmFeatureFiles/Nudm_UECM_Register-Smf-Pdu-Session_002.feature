...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d'{"smfInstanceId": "e09ea573-2ac3-4c22-8def-e2a992ae6da4", "dnn": "ericsson-network", "pduSessionId": 1,"plmnId": {"mcc": "111", "mnc": "222"}, "pcscfRestorationCallbackUri" : "<SMF_SERVER_SCHEME>://<SMF_SERVER_ADDRESS>:<SMF_SERVER_PORT>/pcscfrestoration/imsi-<imsi>/", "singleNssai": {"sd": "000002", "sst": 2}}' 'http://localhost:30096/nudm-uecm/v1/imsi-240810000000000/registrations/smf-registrations/1'

Scenario: Send Register-Smf
  ...
  """
  {
    ...
    "pcscfRestorationCallbackUri" : "<SMF_SERVER_SCHEME>://<SMF_SERVER_ADDRESS>:<SMF_SERVER_PORT>/pcscfrestoration/imsi-<imsi>/",
