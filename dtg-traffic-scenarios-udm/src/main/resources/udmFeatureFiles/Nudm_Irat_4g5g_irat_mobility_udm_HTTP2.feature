...
#This script is a variation of Nudm_Irat_4g5g_irat_mobility_udm_002.feature but using HTTP2 to get more stable results for overload test.
...
#Before run this case, make sure hssIrat4g5g in configrutions should be enabled.
