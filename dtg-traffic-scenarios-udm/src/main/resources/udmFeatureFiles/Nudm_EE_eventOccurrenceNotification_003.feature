Feature: AMF Registration with home plmn
...
#This scenario should be run before Nudm_EE_eventOccurrenceNotification_004.feature
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d'{"guami":{"plmnId":{"mcc":"111","mnc":"222"},"amfId":"A1B2C3"},"amfInstanceId": "AMFID ID 01", "deregCallbackUri": "http://amf01.ericsson.net/callback/uri/deregCallbackUri", "ratType" : "NR" }' 'http://localhost:31380/nudm-uecm/v1/imsi-240810000000001/registrations/amf-3gpp-access'
