Feature: Get AM Data, SMF Select Data, SMS-DATA AND UE-CONTEXT IN SMSF
...
#curl --http2-prior-knowledge -k -i -m 1 -X GET -H'content-type:application/json' 'http://localhost:30082/nudm-sdm/v2/imsi-240810000000000?dataset-names=AM,SMF_SEL,SMS_SUB,UEC_SMSF'

#No other scenarios execution dependencies

Scenario: Send Get-AM-Data, SMF-Select-Data, SMS-Data and UE-Context in SMSF
  Given target type is UDM_HTTP
  Given target tag is HTTP_2
  Given path is /nudm-sdm/v2/imsi-<imsi>?dataset-names=AM,SMF_SEL,SMS_SUB,UEC_SMSF
