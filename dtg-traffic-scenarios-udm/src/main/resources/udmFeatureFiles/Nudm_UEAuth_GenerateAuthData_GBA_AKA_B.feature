Feature: Generate authentication data for GBA-AKA
...
#FT
#curl -k -i -m 1 -X POST -H'content-type:application/json' -d'{"hssAuthType" : "GBA_AKA","numOfRequestedVectors" : 1}' 'http://127.0.0.1:31382/nudm-ueau/v1/imsi-240820000730000/hss-security-information/gba-aka/generate-av'

Scenario: Send GenerateAuthData for GBA-AKA
  Given target type is UDM_HTTP
  Given target tag is HTTP_2
  Given path is /nudm-ueau/v1/imsi-<PreImsi><ImsiBody><msisdn>/hss-security-information/gba-aka/generate-av
  Given request header is Content-Type:application/json
  Given action name is POST-generate-auth-data-gba-aka
