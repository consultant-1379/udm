Feature: AMF 3GPP Access De-Registration for AMF3

#This scenario should be executed after Nudm_UECM_Register-Amf3GPPAccess_003.feature
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PATCH -H'content-type:application/merge-patch+json' -d'{"purgeFlag": true, "guami": {"plmnId": {"mcc": "111", "mnc": "222"}, "amfId": "A1B333"}}' 'http://eric-udm-apigw:9088/nudm-uecm/v1/imsi-240810000000000/registrations/amf-3gpp-access'

Scenario: Send De-Register-Amf3GPPAccess
  ...
  {
    "purgeFlag": true,
    "guami": {"plmnId": {"mcc": "111", "mnc": "222"}, "amfId": "A1B333"}
  }
  """
