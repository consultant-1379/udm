Feature: AMF 3GPP Access Registration from AMF3
...
Scenario: Send Register-Amf3GPPAccess
  ...
  """
  {
    "amfInstanceId": "1ec823fe-4a62-4617-aabf-55d146273333",
    "deregCallbackUri": "<AMF_SERVER_SCHEME(3)>://<AMF_SERVER_ADDRESS(3)>:<AMF_SERVER_PORT(3)>/deregistration/imsi-<imsi>/",
