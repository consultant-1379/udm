Feature: Feature: EE subscription (Event Type = Location Request)
...
Scenario: Default callback handler initialization
  ...
  Given callback request path prefix /namf-evts/v1/subscriptions/<msisdn>
...
Scenario: Send DeleteEeSubscription
  ...
  Given path is /nudm-ee/v1/msisdn-<msisdn>/ee-subscriptions/<msisdn>
