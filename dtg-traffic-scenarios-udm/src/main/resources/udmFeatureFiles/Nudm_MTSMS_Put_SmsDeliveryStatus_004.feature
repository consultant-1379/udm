Feature: Report delivery status for SM with Success report with supi
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d'{"scAddress": "01", "smsDeliveryOutcome": "SUCCESSFUL_TRANSFER", "singleAttemptDelivery": true, "supi": "imsi-<imsi>"}' 'http://localhost:30096/nudm-mtsms/v1/msisdn-860810000000000/delivery-status'
