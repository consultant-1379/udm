Feature: Subscribe SMS MNG Data with ImplicitUnsubscribe
...
Scenario: Send Susbcribe-SDM-Datachange
  ...
  """
  {
    ...
    "monitoredResourceUris" : ["<UDM_CLIENT_SCHEME>://<UDM_CLIENT_DESTINATION_HOST>:<UDM_CLIENT_DESTINATION_PORT>/nudm-sdm/v2/imsi-<imsi>/sms-mng-data"],
  ...
  Then compute SavedSubscriptionId4 using Subscriber-Id-From-Response-Location-Header algorithm
