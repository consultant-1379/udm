Feature: AMF 3GPP Access Registration AMF2 with callback on SCP1.

#This scenario will be run after Nudm_UECM_Register-Amf3GPPAccess_011.feature on SCP traffic mix.
