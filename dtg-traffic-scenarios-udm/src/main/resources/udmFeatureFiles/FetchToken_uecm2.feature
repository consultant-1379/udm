...
Given path is /nnrf-oauth2/v1/oauth2/token
Given request header is Content-Type:application/x-www-form-urlencoded
Given request content is
"""
grant_type=client_credentials&nfInstanceId=<client_id>&nfType=UDM&scope=nudm-uecm&targetNfInstanceId=841d1b7c-5103-11e9-8c09-174c95907e28
"""
...
Then we store key token_uecm2 value <fetchedToken>
