Feature: AMF 3GPP Access Registration AMF1 for AMF handover scenarios

#This scenario will be run before Nudm_UECM_Register-Amf3GPPAccess_AMF2.feature
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d'{"amfInstanceId": "d3ae07bd-b710-4c70-9414-5efac33af027", "deregCallbackUri": "http://amf01.ericsson.net/callback/uri/deregCallbackUri","guami": {"plmnId": {"mcc": "111", "mnc": "222"}, "amfId": "A1B2C3"}}' 'http://localhost:30096/nudm-uecm/v1/imsi-240810000000100/registrations/amf-3gpp-access'
...
Scenario: Send Register-Amf3GPPAccess-AMF1
  ...
  """
  {
    ...
    "guami": {"plmnId": {"mcc": "111", "mnc": "222"}, "amfId": "BAC4C1"},
    "ratType" : "NR",
    "drFlag" : true
  }
  """
