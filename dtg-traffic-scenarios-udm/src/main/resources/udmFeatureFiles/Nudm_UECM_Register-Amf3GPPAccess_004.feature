Feature: AMF 3GPP Access Registration with pcscfRestorationCallbackUri
...
Scenario: Send Register-Amf3GPPAccess
  ...
  """
  {
    ...
    "pcscfRestorationCallbackUri" : "<AMF_SERVER_SCHEME>://<AMF_SERVER_ADDRESS>:<AMF_SERVER_PORT>/pcscfrestoration/imsi-<imsi>/",
