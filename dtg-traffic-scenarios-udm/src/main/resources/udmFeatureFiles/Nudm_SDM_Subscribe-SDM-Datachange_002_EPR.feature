...
Scenario: Send Susbcribe-SDM-Datachange
  ...
  Given action name is POST-subscription-smf
  Given request header is Content-Type:application/json
  Given request content is
  """
  {
    "nfInstanceId" : "1ec823fe-4a62-4617-aabf-55d146271111",
  ...
  Then compute SavedSubscriptionId2 using Subscriber-Id-From-Response-Location-Header algorithm
