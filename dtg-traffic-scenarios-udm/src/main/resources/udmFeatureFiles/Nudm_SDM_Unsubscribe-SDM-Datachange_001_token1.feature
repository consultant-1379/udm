...
#FT
#curl --http2-prior-knowledge -k -i -m 1 -X DELETE -H'content-type:application/json' 'http://localhost:30610/nudm-sdm/v2/imsi-240810000000000/sdm-subscriptions/testinjector-callback-uri-CallbackReferenceUri-am-data'

Scenario: Send Unsusbcribe-AM-Data
  Given target type is UDM_HTTP
  Given target tag is HTTP_2
  Given path is /nudm-sdm/v2/imsi-<imsi>/sdm-subscriptions/<SavedSubscriptionId>
  Given action name is DELETE-subscription-am
