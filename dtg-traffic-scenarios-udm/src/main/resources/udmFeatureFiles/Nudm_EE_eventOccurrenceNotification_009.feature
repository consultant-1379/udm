...
Scenario: Default callback handler initialization
  ...
  Given action name is Amf7BISCreateEventSubscription
...
Scenario: Send Initial Register-Amf3GPPAccess
  ...
  """
  {
    ...
    "amfInstanceId": "1ec823fe-4a62-4617-aabf-55d146277777",
    "deregCallbackUri": "http://amf07.ericsson.net/callback/uri/deregCallbackUri",
    "ratType" : "NR",
