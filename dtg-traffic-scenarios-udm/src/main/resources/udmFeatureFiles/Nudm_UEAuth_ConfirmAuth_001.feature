...
#Provisioning script
#for i in {00001..00100};do IMSI="imsi-2408100000"$i; curl --http2-prior-knowledge -k -i -m 1 -X POST -H'content-type:application/json' -d'{"authType": "EAP_AKA_PRIME", "nfInstanceId": "instanceId", "success": true, "timeStamp": "2000-01-01 12:00:00", "servingNetworkName" : "5G:mnc015.mcc234.3gppnetwork.org"}' 'http://localhost:30082/nudr-dr/v1/subscription-data/'$IMSI'/auth-event'

#FT
#curl --http2-prior-knowledge -k -i -m 1 -X PUT -H'content-type:application/json' -d '{"nfInstanceId": "68ffebdc-8299-11e8-adc0-fa7ae01bbebc", "success": true, "timeStamp": "2018-07-07T17:32:28Z", "authType": "EAP_AKA_PRIME", "servingNetworkName" : "5G:mnc015.mcc234.3gppnetwork.org"}' 'http://localhost:32657/nudm-ueau/v1/imsi-240810000000001/auth-events'
...
Scenario: Send ConfirmAuth
  ...
  Given action name is POST-auth-events-eap-aka
