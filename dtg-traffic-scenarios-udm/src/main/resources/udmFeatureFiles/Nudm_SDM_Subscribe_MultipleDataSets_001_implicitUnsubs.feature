Feature: Subscribe AM Data and SMF Select Data
#Provisioning script
...
Scenario: Send Susbcribe-SDM-Datachange
  ...
  """
  {
    ...
    "monitoredResourceUris" : ["<UDM_CLIENT_SCHEME>://<UDM_CLIENT_DESTINATION_HOST>:<UDM_CLIENT_DESTINATION_PORT>/nudm-sdm/v2/imsi-<imsi>/am-data","<UDM_CLIENT_SCHEME>://<UDM_CLIENT_DESTINATION_HOST>:<UDM_CLIENT_DESTINATION_PORT>/nudm-sdm/v2/imsi-<imsi>/smf-select-data"],
