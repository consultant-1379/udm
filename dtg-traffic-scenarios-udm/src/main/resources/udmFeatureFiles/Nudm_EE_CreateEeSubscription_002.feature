Feature: Subscribe Roaming Status change
...
#FT:
#curl --http2-prior-knowledge -k -i -m 1 -X POST -H'content-type:application/json' -d'{"callbackReference": "http://testinjector/callback/uri/CallbackReferenceUri", "monitoringConfigurations": {"2": {"eventType": "ROAMING_STATUS"}}}' 'http://localhost:31380/nudm-ee/v1/anyUE/ee-subscriptions'
...
Scenario: Send CreateEeSubscription
  ...
  """
  {
    ...
    "monitoringConfigurations": {"2":{"eventType":"ROAMING_STATUS"}}
  }
  """
