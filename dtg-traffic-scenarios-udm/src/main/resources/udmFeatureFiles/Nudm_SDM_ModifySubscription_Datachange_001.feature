Feature: Modify a Subscription to notification of AM data change 
...
#FT
#curl --http2-prior-knowledge -k -i -m 1 -X POST -H'content-type:merge-patch+json' -d '{"monitoredResourceUris": ["http://udm.ericsson.com/nudm-sdm/v2/imsi-<imsi>/am-data"], "expires": "2050-12-31T23:20:50Z"}' 'http://localhost:30080/nudm-sdm/v2/imsi-240820000240000/sdm-subscriptions'
...
Scenario: Send Susbcribe-SDM-Datachange
  ...
  Given path is /nudm-sdm/v2/imsi-<imsi>/sdm-subscriptions/<SavedSubscriptionId>
  Given action name is PATCH-subscription-am
