...
Scenario: Default callback handler initialization
  ...
  Given action name is Amf8BISCreateEventSubscription
...
Scenario: Send Initial Register-Amf3GPPAccess
  ...
  """
  {
    ...
    "amfInstanceId": "1ec823fe-4a62-4617-aabf-55d146280000",
    "deregCallbackUri": "http://amf10.ericsson.net/callback/uri/deregCallbackUri",
    "ratType" : "NR",
 ...
 """
  {
    "subscription": {"eventList": [{"type": "LOSS_OF_CONNECTIVITY"}],
    ...
    "supi": "imsi-<imsi>"},
    "subscriptionId":"http://udm.ericsson.se:8080/amf10/<msisdn>"
  }
  """
