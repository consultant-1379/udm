...
Scenario: Send UDR-DataChangeNotification-AmData
  ...
  """
  {
    ...
    "notifyItems": [{
      "resourceId": "http://udrsim:9082/nudr-dr/v1/subscription-data/imsi-<imsi>/111222/provisioned-data/am-data",
      "changes": [{
  	    "op": "REPLACE",
        "path": "/nssai",
        "origValue": {
        ...
        "op": "REPLACE",
        "path": "/gpsis",
        "origValue": ["msisdn-<msisdn>"],
        "newValue": ["msisdn-<msisdn>","extid-<imsi>@ericsson.com"]
        }]
    }]
  }
  """
