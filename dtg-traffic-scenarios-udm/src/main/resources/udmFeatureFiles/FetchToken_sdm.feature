...
"""
grant_type=client_credentials&nfInstanceId=<client_id>&nfType=UDM&scope=nudm-sdm&targetNfInstanceId=841d1b7c-5103-11e9-8c09-174c95907e28
"""
...
Then we store key token_sdm value <fetchedToken>
