Feature: IMSRegistration_Deregistration

#This scenario will be run after Nudm_UECM_Register-Amf3GPPAccess_001.feature
...
Scenario: Default callback handler initialization
  ...
  Given action name is default-pcscfrestoration-callback-amf1
...
Scenario: Send IMSRegistration_Deregistration
  ...
  Given path is /nudm-voice-uecm/v1/imsi-<imsi>/ims-registration/deregistration
  Given request header is Content-Type:application/json
  Given request content is
  """
  {
    "deregReason": "PCSCF_RESTORATION"
  }
  """
