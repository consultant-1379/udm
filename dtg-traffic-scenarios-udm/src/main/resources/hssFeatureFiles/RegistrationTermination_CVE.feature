#  Scenario for script IMS-290 for CVE environments. 
#  It sends a SOAP Notification (User Termination) to ISM-Cx
...
Scenario: prepare for incoming Registration-Termination-Request from HSS
  ...
  When we receive incoming Diameter Registration-Termination-Request for <imsi>@ims.mnc280.mcc262.3gppnetwork.org
...
Scenario: Send SOAP-Notification-User-Termination-IMS
  ...
  <oldLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$sip:UserName<mscid>_0PublicID0@ericsson.se$R</oldLdapAttributeValue>
  <oldLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$tel:+<msisdn>$R</oldLdapAttributeValue>
  <oldLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$sip:<imsi>@ims.mnc280.mcc262.3gppnetwork.org$R</oldLdapAttributeValue>
  <newLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$sip:UserName<mscid>_0PublicID0@ericsson.se$N</newLdapAttributeValue>
  <newLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$tel:+<msisdn>$N</newLdapAttributeValue>
  <newLdapAttributeValue><imsi>@ims.mnc280.mcc262.3gppnetwork.org$sip:<imsi>@ims.mnc280.mcc262.3gppnetwork.org$N</newLdapAttributeValue>
