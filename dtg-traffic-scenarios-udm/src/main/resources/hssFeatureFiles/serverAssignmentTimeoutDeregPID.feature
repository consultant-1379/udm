Feature: Server Assignment Request Timeout Deregistration

Scenario: Server Assignment Unregistered Request
  ...
  Given action name is Server-Assignment-Timeout-Deregistration
  ...
  [
    ...
    { "name":"Server-Assignment-Type", "value":4},
