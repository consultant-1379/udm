...
Scenario: Profile Update Request
  ...
  [
    ...
    { "name":"User-Data_Sh", "value":"<?xml version=\"1.0\" encoding=\"UTF-8\" ?><Sh-Data><RepositoryData><ServiceIndication>ServiceId1</ServiceIndication><SequenceNumber>1</SequenceNumber></RepositoryData></Sh-Data>"},
