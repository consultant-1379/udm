Feature: Update-EPC-User-EpsLocationState
...
Scenario: Update-EPC-User-EpsLocationState
  ...
  """
    <soap:Envelope
		...
		<modificationInformation typ:dN="EpsDynInfId=EpsDynInf,EpsStaInfId=EpsStaInf,serv=EPS,mscId=${Properties#mscId},ou=multiSCs,dc=operator,dc=com" typ:operation="modify">
                    <affectedLdapAttribute typ:binary="false" typ:ldapAttributeName="EpsLocState" typ:modification="replace">
