...
Scenario: prepare for incoming Delete-Subscriber-Data-Request from HSS
  ...
  When we receive incoming Diameter Delete-Subscriber-Data-Request for <imsi>
...
Scenario: UpdateEPCProfile
  ...
  Given SOAP request property ${Properties#oldattr} equals <<keyIndex>:ATTR>
  Given SOAP request property ${Properties#oldvalue} equals <<keyIndex>:VAL>
        ...
        <soap:Body>
			...
			<ldapAttributeValue>${Properties#imsi}</ldapAttributeValue>
                ...
                <modificationInformation typ:dN="EpsStaInfId=EpsStaInf,serv=EPS,mscId=${Properties#mscId},ou=multiSCs,dc=operator,dc=com" typ:operation="modify">
                    <affectedLdapAttribute typ:binary="false" typ:ldapAttributeName="${Properties#oldattr}" typ:modification="remove">
