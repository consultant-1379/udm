Feature: Subscribe Notifications Request for changes on IMSUserState (11)

Scenario: Subscribe Notifications Request
  ...
  Given action name is Subscribe-Notifications-Request-UserState
  ...
  [
    ...
    { "name":"Subs-Req-Type", "value":0},
    { "name":"Data-Reference", "value":11}
  ]
  """
