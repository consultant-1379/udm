Feature: Update-EPC-User-MSISDN
...
Scenario: Update-EPC-User-MSISDN
  ...
  Given SOAP request property ${Properties#mscId} equals <mscidprefix><new_attr_prefix><mscid>
  Given SOAP request property ${Properties#imsi} equals <imsi>
  Given SOAP request property ${Properties#old_attr} equals <old_attr_prefix><mscid>
  Given SOAP request property ${Properties#new_attr} equals <new_attr_prefix><mscid>
  ...
  """
    <soap:Envelope
		...
		<modificationInformation typ:dN="serv=Identities,mscId=${Properties#mscId},ou=multiSCs,dc=o,dc=com" typ:operation="modify">
                    <affectedLdapAttribute typ:binary="false" typ:ldapAttributeName="MSISDN" typ:modification="replace">
                        <oldLdapAttributeValue>${Properties#old_attr}</oldLdapAttributeValue>
                        <newLdapAttributeValue>${Properties#new_attr}</newLdapAttributeValue>
