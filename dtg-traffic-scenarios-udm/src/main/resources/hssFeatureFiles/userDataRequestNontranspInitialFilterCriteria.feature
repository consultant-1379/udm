Feature: User Data Request Nontransp for Initial Filter Criteria (13)

Scenario: User Data Request Nontransp
  Given Diameter target type is IMS
  Given Diameter application is Sh
  Given Diameter request name is User-Data-Request
  Given action name is User-Data-Nontransp-IFC
  ...
  [
    ...
    { "name":"Data-Reference", "value":13},
    { "name":"Server-Name", "value":"sip:<IMS_CLIENT_ORIGIN_HOST(2)>"}
  ]
  """
