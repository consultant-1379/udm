Feature: User Data Request Nontransp User Location 3G NSI

Scenario: User Data Request Nontransp User Location 3G NSI
  Given Diameter target type is IMS
  Given Diameter application is Sh
  Given Diameter request name is User-Data-Request
  Given action name is User-Data-Request_Location3G
  ...
  [
    ...
    { "name":"Requested-Domain", "value":<<keyIndex>:R_DOMAIN_VAL>},
    { "name":"Current-Location", "value":0},
    { "name":"Serving-Node-Indication", "value":0}
  ]
  """
